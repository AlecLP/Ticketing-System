...
public class AdminController {
	...
	public String showAdminTickets(Principal principal, Model model) {
		Employee user = employeeService.findByEmail(principal.getName());
		List<TicketDto> tickets = ticketMicroserviceClient.sendGetAdminTicketsRequest(user.getEmail());
	...
	@PostMapping("/adminTickets")
	public String sendAdminDecisions(@RequestParam Map<String, String> actions, Principal principal) {
		...
		ticketMicroserviceClient.sendAdminDecisions(dto);
